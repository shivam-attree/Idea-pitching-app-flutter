...
class CommentsNoteScreen extends StatefulWidget {
  final Note note;
  CommentsNoteScreen(this.note);

  @override
  State<StatefulWidget> createState() => new CommentsNoteScreenState();
}

final notesReference = FirebaseDatabase.instance.reference().child('notes');

class CommentsNoteScreenState extends State<CommentsNoteScreen> {
