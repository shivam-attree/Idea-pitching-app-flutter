...
import 'package:idea_pitching_app/investment/investmentNoteScreen.dart';

import 'package:idea_pitching_app/model/note.dart';

class investmentComments extends StatefulWidget {
  @override
  investmentCommentsState createState() => new investmentCommentsState();
}

final notesReference = FirebaseDatabase.instance.reference().child('investment');

class investmentCommentsState extends State<investmentComments> {
  ...
  void _navigateToNote(BuildContext context, Note note) async {
    await Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => investmentNoteScreen(note)),
    );
  }
  ...
  void _createNewNote(BuildContext context) async {
    await Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => investmentNoteScreen(Note(null, '', '',''))),
    );
  }
}
