...
class sportsNoteScreen extends StatefulWidget {
  final Note note;
  sportsNoteScreen(this.note);

  @override
  State<StatefulWidget> createState() => new sportsCommentsNoteScreenState();
}

final notesReference = FirebaseDatabase.instance.reference().child('sports');

class sportsCommentsNoteScreenState extends State<sportsNoteScreen> {
