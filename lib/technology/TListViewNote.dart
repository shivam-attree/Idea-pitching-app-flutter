...
import 'package:idea_pitching_app/technology/TNoteScreen.dart';
import 'package:idea_pitching_app/technology/technologyComments.dart';

class TListViewNote extends StatefulWidget {
  @override
...
class _ListViewNoteState extends State<TListViewNote> {
                  ...
                  children: <Widget>[
                    ...
                    ListTile(
                        ...
                        trailing: new RaisedButton(onPressed: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context) => technologyComments()));
