...
class investmentNoteScreen extends StatefulWidget {
  final Note note;
  investmentNoteScreen(this.note);

  @override
  State<StatefulWidget> createState() => new investmentCommentsNoteScreenState();
}

final notesReference = FirebaseDatabase.instance.reference().child('investment');

class investmentCommentsNoteScreenState extends State<investmentNoteScreen> {
