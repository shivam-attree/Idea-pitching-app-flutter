...
import 'package:idea_pitching_app/technology/technologyNoteScreen.dart';

class technologyComments extends StatefulWidget {
  @override
  technologyCommentsState createState() => new technologyCommentsState();
}

final notesReference = FirebaseDatabase.instance.reference().child('technology');

class technologyCommentsState extends State<technologyComments> {
  ...
  void _navigateToNote(BuildContext context, Note note) async {
    await Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => technologyNoteScreen(note)),
    );
  }
  ...
  void _createNewNote(BuildContext context) async {
    await Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => technologyNoteScreen(Note(null, '', '',''))),
    );
  }
}
